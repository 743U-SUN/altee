...
// 関連記事の型定義
interface RelatedPost extends PostFrontmatter {}
  ...
  try {
    ...
    const updateViewCount = async () => {
      try {
        ...
        // 閲覧数の更新は重要でないので失敗してもユーザー体験には影響しない
      }
    };
    
    // エラーをキャッチするがユーザー体験には影響させない
    updateViewCount().catch(error => {
    ...
    console.error("Error rendering post detail page:", error);
    notFound(); // エラーが発生した場合も404ページを表示
  }
}